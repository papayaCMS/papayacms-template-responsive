...
<!-- Show more links in category teasers (title will be linked anyway) -->
<xsl:param name="SHOW_TEASER_MORE_LINK" select="false()" />

<!-- Metatag: scale viewport depending on display size -->
<xsl:param name="ENABLED_VIEWPORT_SCALE" select="true()" />

<!-- Metatag: disable user scaling for scaled viewport -->
