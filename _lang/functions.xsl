...
<func:function name="papaya-fn:language-text">
  <xsl:param name="text"/>
...
<func:function name="papaya-fn:format-currency">
...
<func:function name="papaya-fn:format-number">
  <xsl:param name="float"/>
  <xsl:param name="pattern">#,##0.00</xsl:param>
  <func:result>
...
<func:function name="papaya-fn:format-date-time">
...
<func:function name="papaya-fn:format-rfc2822">
  <xsl:param name="dateTime" />
  <func:result>
...
<func:function name="papaya-fn:format-date">
  <xsl:param name="date" />
  <xsl:param name="format" select="$DATETIME_DEFAULT_FORMAT" />
  <func:result>
...
<func:function name="papaya-fn:format-time">
  <xsl:param name="time" />
  <xsl:param name="showSeconds" select="false()" />
  <xsl:param name="format" select="$DATETIME_DEFAULT_FORMAT" />
  <func:result>
